...
class Management:
    def __init__(self, root):
        ...
        # Buttons
        self.add_bt = Button(self.frame_1, text='SIGN UP', font=(self.font_1, 14, "bold"), bd=2, command=self.AddStudent, cursor="hand2",
                      bg=self.color_1,fg=self.color_3).place(x=68,y=40,width=90)
        self.view_bt = Button(self.frame_1, text='LOG IN', font=(self.font_1,14, "bold"), bd=2, command=self.GetContact_View,
                      cursor="hand2", bg=self.color_1,fg=self.color_3).place(x=188,y=40,width=90)
        self.update_bt = Button(self.frame_1, text='UPDATE', font=(self.font_1,14, "bold"), bd=2, command=self.GetContact_Update, cursor="hand2",
                      bg=self.color_1,fg=self.color_3).place(x=308,y=40,width=90)
        self.delete_bt = Button(self.frame_1, text='DELETE', font=(self.font_1, 14, "bold"), bd=2, command=self.GetContact_Delete,cursor="hand2",
                      bg=self.color_1,fg=self.color_3).place(x=428,y=40,width=90)
        self.clear_bt = Button(self.frame_1, text='CLEAR', font=(self.font_1, 14, "bold"), bd=2, command=self.ClearScreen, cursor="hand2",
                      bg=self.color_1,fg=self.color_3).place(x=548,y=40,width=90)
        
        self.date_bt = Button(self.frame_1, text='DATE', font=(self.font_1, 14, "bold"), bd=2, command=self.date,cursor="hand2", bg=self.color_1,
                      fg=self.color_3).place(x=668,y=40,width=90)
        self.exit_bt = Button(self.frame_1, text='EXIT', font=(self.font_1, 14, "bold"), bd=2, command=self.Exit,cursor="hand2", bg=self.color_1,
    ...
    def GetContact_View(self):
        ...
        self.submit_bt_2 = Button(self.frame_2, text='Submit', font=(self.font_1, 14, "bold"), bd=2, command=self.CheckContact_View, cursor="hand2", 
    ...
    def GetContact_Update(self):
        ...
        self.getInfo_entry = Entry(self.frame_2, font=(self.font_1, 12), bg=self.color_4, fg=self.color_3)
        self.getInfo_entry.place(x=360, y=220, width=200, height=30)
        self.submit_bt_2 = Button(self.frame_2, text='Submit', font=(self.font_1, 14, "bold"), bd=2, command=self.CheckContact_Update, cursor="hand2",
         bg=self.color_1,fg=self.color_3).place(x=420,y=280,width=80)
    ...
    def GetContact_Delete(self):
        ...
        self.getInfo_entry = Entry(self.frame_2, font=(self.font_1, 12), bg=self.color_4, fg=self.color_3)
        self.getInfo_entry.place(x=360, y=220, width=200, height=30)
        self.submit_bt_2 = Button(self.frame_2, text='Submit', font=(self.font_1, 14, "bold"), bd=2, command=self.DeleteData, cursor="hand2", 
        bg=self.color_1,fg=self.color_3).place(x=420,y=280,width=80)
    ...
    def date(self):
        ...
        self.submit_bt_2 = Button(self.frame_2, text='Submit', font=(self.font_1, 14, "bold"), bd=2, command=self.Checkdate_View, cursor="hand2", 
        bg=self.color_1,fg=self.color_3).place(x=420,y=280,width=80)
    ...
    def GetUpdateDetails(self, row):
        ...
        self.submit_bt_1 = Button(self.frame_2, text='Submit', font=(self.font_1, 15, "bold"), bd=2, command=partial(self.UpdateDetails, row), 
    ...
    def ShowDetails(self, row):
        self.ClearScreen()
        name = Label(self.frame_2, text="First Name", font=(self.font_2,15,"bold"), bg=self.color_2).place(x=100,y=20)
        name_data = Label(self.frame_2, text=row[0], font=(self.font_1, 10)).place(x=100, y=50)

        surname = Label(self.frame_2, text="Last Name", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=530,y=20)
        surname_data = Label(self.frame_2, text=row[1], font=(self.font_1, 10)).place(x=530, y=50)

        course = Label(self.frame_2, text="Course", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=100,y=80)
        course_data = Label(self.frame_2, text=row[2], font=(self.font_1, 10)).place(x=100, y=110)

        Course_Package = Label(self.frame_2, text="Course Package", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=530,y=80)
        Course_Package = Label(self.frame_2, text=row[3], font=(self.font_1, 10)).place(x=530, y=110)

        Date = Label(self.frame_2, text="Date", font=(self.font_2, 15, "bold"), bg=self.color_2).place(x=100,y=140)
